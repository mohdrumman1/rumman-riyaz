      ...
      <div className="section-container">
        <div className="formaai-inner animate-in" ref={ref}>
          <div className="formaai-left">
            ...
            <p className="formaai-subheading">AI automation for Australian small businesses</p>
            <p className="formaai-body">
              Forma AI builds voice agents, AI receptionists, and lead nurture automations that help Australian SMBs stop losing revenue to missed calls and slow follow-up. Purpose-built for trades, services, and local businesses competing against enterprise operations.
            </p>
